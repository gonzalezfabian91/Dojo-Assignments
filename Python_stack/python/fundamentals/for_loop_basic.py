...
# 2. Multiples of Five - Print all the nultiples of 5 from 5 to 1,000
...
#and going through highNum, print only the integers that are multiple of mult. For example,
